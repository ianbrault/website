...
function getMatchupStats(users: User[], games: GameStats[]): MatchupStats {
    const stats: MatchupStats = {
        maxScore: emptyGameStats(),
        minScore: emptyGameStats(),
        biggestBlowout: emptyGameStats(),
        closestGame: emptyGameStats(),
        users: {},
    };
...
function getTransactionStats(
    users: User[],
    rosters: Roster[],
    transactions: ByYear<Transaction[]>,
): TransactionStats {
